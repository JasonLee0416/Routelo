...
/**
 * JNI C++ class for module 'NativeDevToolsSettingsManager'
 */
class JSI_EXPORT NativeDevToolsSettingsManagerSpecJSI : public JavaTurboModule {
public:
  NativeDevToolsSettingsManagerSpecJSI(const JavaTurboModule::InitParams &params);
};
